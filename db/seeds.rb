...
Size.create!(product_number: 800100, size: "S", brand_id: Brand.second.id, colorway: 'Black', product_id: Product.find_by(product_number: 800100).id, stock: 10)
Size.create!(product_number: 800100, size: "M", brand_id: Brand.second.id, colorway: 'Black', product_id: Product.find_by(product_number: 800100).id, stock: 10)
Size.create!(product_number: 800100, size: "L", brand_id: Brand.second.id, colorway: 'Black', product_id: Product.find_by(product_number: 800100).id, stock: 10)
...
Size.create!(product_number: 800101, size: "3-6 Months", brand_id: Brand.second.id, colorway: 'Black', product_id: Product.find_by(product_number: 800101).id, stock: 10)
Size.create!(product_number: 800101, size: "6-12 Months", brand_id: Brand.second.id, colorway: 'Black', product_id: Product.find_by(product_number: 800101).id, stock: 10)
Size.create!(product_number: 800101, size: "18-24 Months", brand_id: Brand.second.id, colorway: 'Black', product_id: Product.find_by(product_number: 800101).id, stock: 10)
