...
Product.create!(
  ...
  fit_details: "Tailored fit. Zipper fly, reinforced tab, & button closure. 2 side slant & 2 rear welt pockets. Full stretch lining. Premium construction. 10\" rise & 25 1/2\" inseam",
...
Product.create!(
  ...
  details: "97% cotton, 3% spandex. Machine wash cold, dry flat. The fabric will stretch to your figure and then return back to original shape after washing.",
  fit_details: "Pop stitch detailing. Deep, functional pockets. 28\" inseam.",
